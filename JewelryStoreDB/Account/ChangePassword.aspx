<%@ Page Title="ChangePassword" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
        New password should be at least <%= Membership.MinRequiredPasswordLength %> characters.
    </p>
                ...
                <fieldset class="changePassword">
                    ...
                    <p>
                        ...
                        <asp:CompareValidator ID="NewPasswordCompare" runat="server" ControlToCompare="NewPassword" ControlToValidate="ConfirmNewPassword" 
                             CssClass="failureNotification" Display="Dynamic" ErrorMessage="Confirm New Password should be same as New Password."
